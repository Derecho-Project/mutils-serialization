...
#define DEFAULT_SERIALIZE15(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o) std::size_t to_bytes(char* ret) const { \
        int bytes_written = mutils::to_bytes(a,ret);  \
        bytes_written += mutils::to_bytes(b,ret + bytes_written); \
        bytes_written += mutils::to_bytes(c,ret + bytes_written); \
        bytes_written += mutils::to_bytes(d,ret + bytes_written); \
...
#define DEFAULT_SERIALIZE16(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p) std::size_t to_bytes(char* ret) const { \
        int bytes_written = mutils::to_bytes(a,ret);  \
        bytes_written += mutils::to_bytes(b,ret + bytes_written); \
        bytes_written += mutils::to_bytes(c,ret + bytes_written); \
        bytes_written += mutils::to_bytes(d,ret + bytes_written); \
...
#define DEFAULT_SERIALIZE17(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q) std::size_t to_bytes(char* ret) const { \
        int bytes_written = mutils::to_bytes(a,ret);  \
        bytes_written += mutils::to_bytes(b,ret + bytes_written); \
        bytes_written += mutils::to_bytes(c,ret + bytes_written); \
        bytes_written += mutils::to_bytes(d,ret + bytes_written); \
...
#define DEFAULT_SERIALIZE18(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r) std::size_t to_bytes(char* ret) const { \
        int bytes_written = mutils::to_bytes(a,ret);  \
        bytes_written += mutils::to_bytes(b,ret + bytes_written); \
        bytes_written += mutils::to_bytes(c,ret + bytes_written); \
        bytes_written += mutils::to_bytes(d,ret + bytes_written); \
...
#define DEFAULT_SERIALIZE19(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s) std::size_t to_bytes(char* ret) const { \
        int bytes_written = mutils::to_bytes(a,ret);  \
        bytes_written += mutils::to_bytes(b,ret + bytes_written); \
        bytes_written += mutils::to_bytes(c,ret + bytes_written); \
        bytes_written += mutils::to_bytes(d,ret + bytes_written); \
...
#define DEFAULT_SERIALIZE20(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t) std::size_t to_bytes(char* ret) const { \
        int bytes_written = mutils::to_bytes(a,ret);  \
        bytes_written += mutils::to_bytes(b,ret + bytes_written); \
        bytes_written += mutils::to_bytes(c,ret + bytes_written); \
        bytes_written += mutils::to_bytes(d,ret + bytes_written); \
